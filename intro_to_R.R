...
# "high calls" is high frequency calls ≥35 kHz (correponds to little brown bats and some other smaller)
...
## of fluorescence which indicate presence of prions in a sample. this data set is from an experiment
